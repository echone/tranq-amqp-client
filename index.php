...
<html lang="en">
    ...
    <title>Upload Something</title>
	    ...
	    <body>
	    	...
	    	<h4>1- (OPTIONAL) Set the date/time. Use format YYMMDD-HH:mm. (If not set it takes the current date/time)</h4><p>
	...
	<h5>Pay attention, I've to choose 1_anno_aule_virtuali for 19,00/20,00 1 year FAD lessons</h5>
	<form id="upload-form"
	      method="post" 
	      action="upload.php"
